...
public:
    ...
    QGroupBox *gbCustomSettings;
    QVBoxLayout *verticalLayout_5;
    QPushButton *btnOpenDir;
    QLineEdit *lineSettings;
    QPushButton *btnLoadCustom;
    QSpacerItem *verticalSpacer;
    QPushButton *btnTBrows;
    ...
    void setupUi(QWidget *SetupTab)
    {
        ...
        gbCustomSettings = new QGroupBox(groupBox_2);
        gbCustomSettings->setObjectName(QString::fromUtf8("gbCustomSettings"));
        QSizePolicy sizePolicy1(QSizePolicy::Preferred, QSizePolicy::Fixed);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(gbCustomSettings->sizePolicy().hasHeightForWidth());
        gbCustomSettings->setSizePolicy(sizePolicy1);
        verticalLayout_5 = new QVBoxLayout(gbCustomSettings);
        verticalLayout_5->setObjectName(QString::fromUtf8("verticalLayout_5"));
        btnOpenDir = new QPushButton(gbCustomSettings);
        btnOpenDir->setObjectName(QString::fromUtf8("btnOpenDir"));

        verticalLayout_5->addWidget(btnOpenDir);

        lineSettings = new QLineEdit(gbCustomSettings);
        lineSettings->setObjectName(QString::fromUtf8("lineSettings"));
        lineSettings->setMaximumSize(QSize(165, 16777215));
        lineSettings->setReadOnly(true);

        verticalLayout_5->addWidget(lineSettings);

        btnLoadCustom = new QPushButton(gbCustomSettings);
        btnLoadCustom->setObjectName(QString::fromUtf8("btnLoadCustom"));

        verticalLayout_5->addWidget(btnLoadCustom);

        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout_5->addItem(verticalSpacer);

        btnTBrows = new QPushButton(gbCustomSettings);
        btnTBrows->setObjectName(QString::fromUtf8("btnTBrows"));

        verticalLayout_5->addWidget(btnTBrows, 0, Qt::AlignBottom);


        horizontalLayout_3->addWidget(gbCustomSettings, 0, Qt::AlignHCenter|Qt::AlignTop);
    ...
    void retranslateUi(QWidget *SetupTab)
    {
        ...
        gbCustomSettings->setTitle(QString());
        btnOpenDir->setText(QApplication::translate("SetupTab", "Open Directory", 0, QApplication::UnicodeUTF8));
        btnLoadCustom->setText(QApplication::translate("SetupTab", "Load Custom Settings", 0, QApplication::UnicodeUTF8));
        btnTBrows->setText(QApplication::translate("SetupTab", "Open TBrowser", 0, QApplication::UnicodeUTF8));
